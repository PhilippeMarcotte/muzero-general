...
class MuZeroConfig:
    def __init__(self):
        ...
        self.reanalyze_mode = "fast"  # or "true"
        self.num_reanalyze_cpus = 91
        ### Replay Buffer
        self.window_size = 75  # Number of self-play games to keep in the replay buffer
        ...
        self.ratio = 0.25  # Desired self played games per training step ratio. Equivalent to a synchronous version, training can take much longer. Set it to None to disable it
