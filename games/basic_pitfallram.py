...
class MuZeroConfig:
    def __init__(self):
        ...
        self.fc_reward_layers = [64, 64, 32, 32]  # Define the hidden layers in the reward network
        self.fc_value_layers = [64, 64, 32, 32]  # Define the hidden layers in the value network
        self.fc_policy_layers = [64, 64, 32, 32]  # Define the hidden layers in the policy network
        self.fc_representation_layers = [256, 256, 128]  # Define the hidden layers in the representation network
        self.fc_dynamics_layers = [64, 64, 32, 32]  # Define the hidden layers in the dynamics network
...
class Game(AbstractGame):
    ...
    def __init__(self, seed=None):
        self.env = gym.make("Pitfall-ram-v4")
        if seed is not None:
            self.env.seed(seed)
